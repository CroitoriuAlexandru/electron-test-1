...
export default function App() {
  ...
  return (
    <div className="">
      <aside
        class="bg-neutral-400 w-[100vw] h-screen pt-14 transition-transform -translate-x-full border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidenav"
